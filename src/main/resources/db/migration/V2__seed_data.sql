...
-- Insert permissions (id auto-generated by BIGSERIAL, uuid is the business identifier)
INSERT INTO auth.permissions (uuid, name, description, resource, action) VALUES
    -- User permissions
...
-- Insert roles (id auto-generated by BIGSERIAL, uuid is the business identifier)
INSERT INTO auth.roles (uuid, name, description, is_default, is_system) VALUES
    -- General roles
