    ...
    <div class="min-h-screen flex">
      ...
      <div class="flex-1 flex items-center justify-center p-8">
        <div class="w-full max-w-md">
          ...
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="space-y-6">
            <div>
              <label for="usernameOrEmail" class="label">Email or Username</label>
              <input
                type="text"
                id="usernameOrEmail"
              ...
              />
              <p *ngIf="loginForm.get('usernameOrEmail')?.invalid && loginForm.get('usernameOrEmail')?.touched" class="mt-1 text-sm text-danger-500">
            ...
            <div>
              ...
              <p *ngIf="loginForm.get('password')?.invalid && loginForm.get('password')?.touched" class="mt-1 text-sm text-danger-500">Password is required</p>
            </div>

            <div class="flex items-center justify-between">
              <label class="flex items-center">
                <input type="checkbox" formControlName="rememberMe" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" />
      ...
      <div class="hidden lg:flex lg:flex-1 bg-primary-600 items-center justify-center p-12">
        <div class="max-w-lg text-center">
          ...
          <h2 class="mt-8 text-3xl font-bold text-white">Secure Access</h2>
